...
hidden if the `cloxc_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `cloxc_DEVELOPER_MODE` to the configure
...
Runs the executable target `cloxc_exe`.
